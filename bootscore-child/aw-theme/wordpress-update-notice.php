 ...
 * @version 1.0.1
 * 
 * This file contains all functionality for automatically updating
 * the WordPress theme from a GitHub repository.
 */
...
if (!class_exists('AW_GitHub_Theme_Updater')) {
  ...
  class AW_GitHub_Theme_Updater {
    ...
    public function __construct() {
      ...
      // Get GitHub info manually from style.css
...
add_action('admin_notices', function() {
  if (current_user_can('manage_options')) {
    ...
    if ($current_page == 'themes.php') {
      ...
      echo '<p><strong>AW GitHub Updater Debug:</strong><br>';
